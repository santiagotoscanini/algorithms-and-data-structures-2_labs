...
public class Ejercicio7 {
    ...
    static class Graph {
        ...
        public Integer numberOfComponentes(){
            Kruskal();
            Integer components = 0;
            Boolean[] rootsSame = new Boolean[roots.length];
            for (int i = 1; i < rootsSame.length; i++) {
                rootsSame[i]=false;
            }
            for (int i = 1; i < roots.length; i++) {
                rootsSame[root(i)]=true;
            }
            for (int i = 1; i < rootsSame.length; i++) {
                components+= rootsSame[i]?1:0;
            }
            return components;
        }
